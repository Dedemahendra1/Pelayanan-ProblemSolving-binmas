...
<html lang="en">
  <head>
    ...
    <title> BHABINKAMTIBMAS POLSEK MEDAN BARAT </title>
      ...
      <div class="main_container">
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            ...
            <center>
            &nbsp; <a href="index.php" class="fa fa-university  fa-2x" style="color:#fff;"><span><font size="4.95" color="white" face="Helvetica Neue"></font></span></a>
            </center>
            </div>
              ...
              <div class="menu_section">
                <ul class="nav side-menu">
                  <li><a href="index.php"><i class="fa fa-home"></i> Home <span class="fa fa-chevron"></span></a>
                   ...
                   <li><a><i class="fa fa-desktop"></i> Problem Solving <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="index.php?page=input_data">Input Data</a></li>
                      <li><a href="index.php?page=tambah_data">Tambah Data</a></li>
                      <li><a href="index.php?page=tanggapan">Tanggapan</a></li>
                      <li><a href="index.php?page=Tambah_tanggap">Tambah Tanggap</a></li>
                    </ul>
                  </li>
                  <li><a href="#"><i class="fa fa-desktop"></i> Validasi <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                  ...
                  <li><a><i class="fa fa-file"></i> Laporan <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="laporan.php">Cetak</a></li>
                    </ul>
                  </li>
                </ul>
              </div>
